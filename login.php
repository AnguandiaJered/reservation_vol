...
<head>
        ...
        <link rel="icon" type="img" href="assets/caa.png">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-5">
                            <div class="misc-header text-center">
                                ...
                                <h1><strong>AGENCE DE VOYAGE CAA</strong></h1>
                            </div>
                            <div class="misc-box">      
                                <form role="form" method="POST" action="session.php" autocomplete="off">                                
                                    <div class="form-group">                                      
                                        ...
                                        <input id="exampleuser1" type="email" name="email" placeholder="email" class="form-control" autofocus>
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <div class="float-right">
                                            <input type="submit" class="btn btn-block btn-primary btn-rounded box-shadow" value="Se connecter" />
                                        </div>
                                    </div>
                                    <hr>
                            ...
                            <div class="text-center misc-footer">
                               <p>Copyright &copy; 2023 Agence de voyage CAA</p>
                            </div>
                        </div>
                    </div>
                </div>
