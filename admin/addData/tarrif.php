...
if(move_uploaded_file($_FILES['photo']['tmp_name'],'../images/'.$url_img)){
   require '../../config/database.php';
            ...
            $req=$db->prepare('INSERT INTO `tarifs`(`provenance`, `destination`, `heure_depart`, `heure_arriver`,`date_depart`, `date_arriver`, `class_id`, `vol_id`,photo) 
            VALUES (:provenance,:destination,:heure_depart,:heure_arriver,:date_depart,:date_arriver,:class_id,:vol_id,:photo)');
            $req->execute(array(
